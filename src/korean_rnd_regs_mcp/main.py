...
_SERVER_INSTRUCTIONS = (
    ...
    "도구 호출 결과 질문 대상이 지원 63개 규정 밖이면 본 서버 근거로 확인되지 않았음을 밝히고, "
