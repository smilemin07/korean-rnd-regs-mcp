...
_SERVER_INSTRUCTIONS = (
    ...
    "도구 호출 결과 질문 대상이 지원 28개 규정 밖이면 본 서버 근거로 확인되지 않았음을 밝히고, "
    "답변을 덧붙일 경우 일반 학습지식에 따른 설명임을 명시하여 1차 출처(국가법령정보센터 등) 확인을 권하십시오."
)
...
- Tier 2 (사업 운영규정·요령): 국토교통부소관 연구개발사업 운영규정, 산업기술혁신사업 공통 운영요령, 중소기업기술개발 지원사업 운영요령, 기술료 징수 및 관리에 관한 통합요령(산업부), 중소기업기술개발 지원사업 기술료 관리규정(중기부)
...
@mcp.prompt(
    ...
    description=(
        "본 MCP 적용 범위 내 국가연구개발 및 국토교통·산업·중소기업 R&D 연구행정 규정 검토 — 혁신법·시행령·시행규칙·"
