...
_SERVER_INSTRUCTIONS = (
    ...
    "본 서버는 규정 원문 도구 외에 「국가연구개발혁신법 매뉴얼」(본권·별권 3 「국가연구개발사업 제재처분 가이드라인」·별권 2 「국가연구개발사업 기술료 제도 매뉴얼」·별권 1 「학생인건비통합관리 제도 매뉴얼」·별권 4 「연구시설･장비비 통합관리제 운영･관리 매뉴얼」)과 「국가연구개발 과제평가 표준지침」(과학기술정보통신부·2025.12) 해설·지침 조회 도구 search_manual·get_manual_section을 제공합니다. "
    "혁신법령 관련 실무 해설·세부 절차·Q&A·사례 설명이나 과제평가(선정·단계·특별·최종) 기준·절차 안내가 필요하면 search_manual로 절을 찾고 get_manual_section으로 본문을 확인하십시오"
    "(검색은 본권·별권 3·별권 2·별권 1·과제평가 표준지침·별권 4를 함께 훑으며 매치의 source·citation으로 어느 자료인지 구분됩니다. 제재처분 기간·비율 등 구체값은 시행령 별표 6·별표 7 원문을, 기술료율·납부 상한 등 구체값은 시행령 제38조~제41조 원문을, 학생인건비·연구시설장비비 계상기준·적립·사용 요건 등 구체값은 연구개발비 사용 기준 원문을 get_provision_detail로 교차 확인. 과제평가 표준지침은 각 부처 평가지침의 기준이므로 구체 과제에는 소관 부처·전문기관의 평가지침·공고가 함께 적용됨을 안내). "
...
- 해설 자료(별도 도구): 「국가연구개발혁신법 매뉴얼」(본권·별권 3 제재처분 가이드라인·별권 2 기술료 제도 매뉴얼·별권 1 학생인건비통합관리 제도 매뉴얼·별권 4 연구시설･장비비 통합관리제 운영･관리 매뉴얼)과 「국가연구개발 과제평가 표준지침」(과기정통부·2025.12) 해설·지침은 search_manual·get_manual_section으로 조회 가능 — 단 해설·지침 자료이며 법령·행정규칙이 아니므로 근거 조항을 대체할 수 없음.
- 미커버: 기관 내부 기준, 기타 부처별 매뉴얼·가이드(혁신법 매뉴얼 본권·별권 1~4 전권 수록 — 별권 3은 v0.32.0, 별권 2는 v0.33.0, 별권 1은 v0.35.0, 별권 4는 v0.39.0부터. 「국가연구개발 과제평가 표준지침」(25.12)은 v0.38.0부터 수록)
...
4. 위계 순서에 따른 상세 조회
   ...
   - (선택) 실무 해설·세부 절차·Q&A가 유용한 경우 search_manual·get_manual_section으로 「국가연구개발혁신법 매뉴얼」(본권·별권 3 제재처분 가이드라인·별권 2 기술료 제도 매뉴얼·별권 1 학생인건비통합관리 제도 매뉴얼·별권 4 연구시설･장비비 통합관리제 운영･관리 매뉴얼)·「국가연구개발 과제평가 표준지침」 해설을 참조할 것. 단 매뉴얼은 해설 자료이며 법령·행정규칙이 아니므로 4절 근거 조항은 법령·행정규칙만으로 구성하고, 매뉴얼 내용은 3절 핵심 답변·7절 권고 조치의 보조 설명으로만 매뉴얼 해설임을 구분 표기하고 출처는 응답의 citation 값을 그대로 적을 것. 매뉴얼과 법령·행정규칙 내용이 다르면 법령·행정규칙 원문 우선.
...
async def search_manual(query: str) -> dict:
    """사용 시점: 「국가연구개발혁신법 매뉴얼」 본권(범부처 공통 해설서)·별권 3 「국가연구개발사업 제재처분 가이드라인」·별권 2 「국가연구개발사업 기술료 제도 매뉴얼」·별권 1 「학생인건비통합관리 제도 매뉴얼」·별권 4 「연구시설･장비비 통합관리제 운영･관리 매뉴얼」·「국가연구개발 과제평가 표준지침」(과학기술정보통신부·2025.12)에서 혁신법령의 실무 해설·세부 절차·Q&A·사례·제재처분 절차와 기준 해설·기술료 제도 해설·학생인건비통합관리 해설·연구시설·장비비 통합관리 해설·과제평가(선정·단계·특별·최종) 기준과 절차를 찾을 때 호출하십시오. 이 도구는 법령·행정규칙 조문 원문 검색이 아닙니다 — 조문 원문·현행 여부 확인은 search_provision·get_provision_detail을 사용하고, 매뉴얼·지침과 법령·행정규칙 내용이 다르면 법령·행정규칙 원문이 우선합니다.

    본권(43개 절·인쇄 1~332쪽·부록 제외)·별권 3(23개 단위·인쇄 1~89쪽)·별권 2(15개 단위·
    인쇄 1~12쪽)·별권 1(26개 단위·인쇄 3~91쪽)·과제평가 표준지침(15개 단위·인쇄 1~60쪽)·
    별권 4(11개 단위·인쇄 3~50쪽)를
    함께 절 단위로 검색합니다. 매칭은
    search_provision과 동일한 토큰 AND(공백 분해·2자 이상 토큰 2개 이상이면 모든 토큰 존재 시
    매칭, 그 외 리터럴)이며, 가운뎃점 표기차(ㆍ·･·)는 매칭에서 흡수합니다(발췌는 원문 그대로).
    정렬은 제목 매치 우선·같은 단계에서는 본권, 그다음 별권 3·별권 2·별권 1·과제평가 표준지침·별권 4 순입니다.

    응답: matches[](source["main"=본권|"b3"=별권 3|"b2"=별권 2|"b1"=별권 1|"eval"=과제평가 표준지침|"b4"=별권 4]·절 메타·인쇄쪽 범위·매치
...
async def get_manual_section(section_id: str, chunk: int | None = None) -> dict:
    """사용 시점: search_manual로 찾은 「국가연구개발혁신법 매뉴얼」 본권·별권 3 「국가연구개발사업 제재처분 가이드라인」·별권 2 「국가연구개발사업 기술료 제도 매뉴얼」·별권 1 「학생인건비통합관리 제도 매뉴얼」·별권 4 「연구시설･장비비 통합관리제 운영･관리 매뉴얼」·「국가연구개발 과제평가 표준지침」 절의 본문 전문이 필요할 때 호출하십시오. 이 도구는 해설·지침 자료 조회이며 법령·행정규칙 원문 조회가 아닙니다 — 조문 원문은 get_provision_detail을 사용하고, 매뉴얼·지침과 법령·행정규칙 내용이 다르면 법령·행정규칙 원문이 우선합니다.
    ...
    또는 별권 4 id(장 없는 평면 편제라 단일 레벨): "b4-0"(개요)·"b4-1"~"b4-9"(본문 Ⅰ~Ⅸ·예:
    ...
    (rnd_funding_standard·연구시설·장비비 통합관리는 제100조~제111조) 원문을 교차 확인하십시오.
        ...
        return {
            "errors": [{
                ...
                "message": _sanitize_error_message(
                    ...
                    "과제평가 표준지침 'eval-장-절'(예: 'eval-3-2')·'eval-ref-N'(예: 'eval-ref-6') 또는 "
