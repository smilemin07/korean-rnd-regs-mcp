...
== MCP 적용 범위 (17개 규정) ==
- Tier 1 (혁신법 family): 혁신법·시행령·시행규칙
- Tier 1 (Sector — 국토교통 R&D family, v0.1.3 추가): 국토교통과학기술 육성법·시행령·시행규칙
- Tier 2 (핵심 행정규칙): 연구개발비 사용 기준·동시수행 제한·시설장비 표준지침·연구노트 지침, 국토교통부소관 연구개발사업 운영규정(v0.1.3 추가)
...
- 일반법(혁신법) vs 특별법(육성법) 적용 우선순위는 사안의 특성에 따라 판단하십시오.
