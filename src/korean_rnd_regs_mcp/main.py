...
_SERVER_INSTRUCTIONS = (
    ...
    "본 서버는 규정 원문 도구 외에 「국가연구개발혁신법 매뉴얼」(본권·별권 3 「국가연구개발사업 제재처분 가이드라인」·별권 2 「국가연구개발사업 기술료 제도 매뉴얼」·별권 1 「학생인건비통합관리 제도 매뉴얼」) 해설 조회 도구 search_manual·get_manual_section을 제공합니다. "
    "혁신법령 관련 실무 해설·세부 절차·Q&A·사례 설명이 필요하면 search_manual로 절을 찾고 get_manual_section으로 본문을 확인하십시오"
    "(검색은 본권·별권 3·별권 2·별권 1을 함께 훑으며 매치의 source·citation으로 어느 자료인지 구분됩니다. 제재처분 기간·비율 등 구체값은 시행령 별표 6·별표 7 원문을, 기술료율·납부 상한 등 구체값은 시행령 제38조~제41조 원문을, 학생인건비 계상기준·지급액 등 구체값은 연구개발비 사용 기준 원문을 get_provision_detail로 교차 확인). "
...
- 해설 자료(별도 도구): 「국가연구개발혁신법 매뉴얼」(본권·별권 3 제재처분 가이드라인·별권 2 기술료 제도 매뉴얼·별권 1 학생인건비통합관리 제도 매뉴얼) 해설은 search_manual·get_manual_section으로 조회 가능 — 단 해설 자료이며 법령·행정규칙이 아니므로 근거 조항을 대체할 수 없음.
- 미커버: 기관 내부 기준, 기타 부처별 매뉴얼·가이드, 혁신법 매뉴얼 별권 중 1종(연구시설장비 — 별권 3 제재처분 가이드라인은 v0.32.0, 별권 2 기술료 제도 매뉴얼은 v0.33.0, 별권 1 학생인건비통합관리 제도 매뉴얼은 v0.35.0부터 수록)
...
4. 위계 순서에 따른 상세 조회
   ...
   - (선택) 실무 해설·세부 절차·Q&A가 유용한 경우 search_manual·get_manual_section으로 「국가연구개발혁신법 매뉴얼」(본권·별권 3 제재처분 가이드라인·별권 2 기술료 제도 매뉴얼·별권 1 학생인건비통합관리 제도 매뉴얼) 해설을 참조할 것. 단 매뉴얼은 해설 자료이며 법령·행정규칙이 아니므로 4절 근거 조항은 법령·행정규칙만으로 구성하고, 매뉴얼 내용은 3절 핵심 답변·7절 권고 조치의 보조 설명으로만 매뉴얼 해설임을 구분 표기하고 출처는 응답의 citation 값을 그대로 적을 것. 매뉴얼과 법령·행정규칙 내용이 다르면 법령·행정규칙 원문 우선.
...
async def search_manual(query: str) -> dict:
    ...
    인쇄 1~12쪽)·별권 1(26개 단위·인쇄 3~91쪽)을 함께 절 단위로 검색합니다. 매칭은
    search_provision과 동일한 토큰 AND(공백 분해·2자 이상 토큰 2개 이상이면 모든 토큰 존재 시
    매칭, 그 외 리터럴)이며, 가운뎃점 표기차(ㆍ·･·)는 매칭에서 흡수합니다(발췌는 원문 그대로).
    정렬은 제목 매치 우선·같은 단계에서는 본권, 그다음 별권 3·별권 2·별권 1 순입니다.

    응답: matches[](source["main"=본권|"b3"=별권 3|"b2"=별권 2|"b1"=별권 1]·절 메타·인쇄쪽 범위·매치
        ...
        return {
            "errors": [{
                ...
                "message": _sanitize_error_message(
                    ...
                    "별권 2 'b2-장-절'(예: 'b2-3-2')·'b2-ref-1' 또는 "
