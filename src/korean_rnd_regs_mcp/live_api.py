...
class LawApiClient:
    ...
    def __init__(self, env_override: Optional[dict] = None) -> None:
        ...
        self._detail_cache: TTLCache = TTLCache(maxsize=64, ttl=86400)  # v0.4.0: 50→64 — 규정 확대 선제 마진(v0.13.0 현재 N=52<64, warm-hit 보존·headroom 12). N>64 확대 시 warm-hit 무력화 대비 상향 검토
