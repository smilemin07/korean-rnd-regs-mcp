...
| `get_manual_section`     | 매뉴얼 절 본문 조회(본권 `3-4`형·별권 3 `b3-4-2`형·별권 2 `b2-3-2`형 id) — 대형 절은 페이지 경계 분할 청크. 모든 비오류 응답에 규범성 메타(해설 자료·법령 우선)·완성형 인용구·하단 표준 안내 블록 동반 (v0.28.0) |
