...
「국가연구개발혁신법 매뉴얼」(본권, 26.7판·법령 시행일 2026.6월 기준) 본문 해설부(5개 장 40개 절 + 참고 3건·인쇄 1~332쪽)를 절 단위로 검색·조회할 수 있습니다.
...
- 수록 범위: 본권 본문 해설부만. 부록 관련 서식(26.7판부터 별도 PDF로 분리 발간)과 별권 4종(학생인건비·기술료·제재처분·연구시설장비)은 미수록입니다.
