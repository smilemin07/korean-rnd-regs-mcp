...
- 국토교통부 자율주행 R&D 실무 행정규칙 1건 추가 지원((국토교통부) 자율주행기술개발혁신사업 운영관리규정 / 지원 규정 63 → 64개)

### 2026. 7. 24.: v0.25.0

- 방위사업청 국방 R&D 실무 행정규칙 3건 추가 지원(미래도전국방기술 연구개발 업무처리지침·국방연구개발 시설·장비의 관리 등에 관한 규정·무기체계 연구개발 표준협약서 / 지원 규정 60 → 63개)
  - 미래도전국방기술 연구개발 업무처리지침(예규 제1040호): 미래도전국방기술 연구개발사업의 실무 절차·기준(조문 49·활성 별표 전건 본문 전문 제공)
  - 국방연구개발 시설·장비의 관리 등에 관한 규정(훈령 제945호): 국방 연구시설·장비 관리 실무(조문 18·별표 16 — 대용량 별표 8은 청크 조회 지원)
  - 무기체계 연구개발 표준협약서(예규 제1019호): 무기체계 연구개발 협약의 표준 조문(조문 45)

### 2026. 7. 23.: v0.24.0

- 방위사업청 국방 R&D 실무 행정규칙 2건 추가 지원(국방기술 연구개발 업무처리지침·국방과학 기술료 고시 / 지원 규정 58 → 60개)
  - 업무처리지침(예규 제1045호): 핵심기술·미래도전국방기술 연구개발사업의 실무 절차·기준(조문 76·별표 7 전건 본문 전문 제공)
  - 기술료 고시(고시 제2026-4호): 국방과학 기술료 산정·징수방법·징수절차(법 제11조·시행령 제14조 위임)
  - 내부 캐시 상한 상향(64→96) — 규정 수 증가에 따른 응답 속도(warm-hit) 보존 목적, 사용 방법 변화 없음

### 2026. 7. 23.: v0.23.0

- 방위사업청 국방 R&D 규정 3건 추가 지원(국방과학기술혁신 촉진법·시행령·시행규칙 / 지원 규정 55 → 58개)
  - 국방 R&D는 국가연구개발혁신법이 아닌 국방과학기술혁신 촉진법 체계가 적용됨을 AI가 인지하도록 안내 추가(혁신법 제3조제3호의 보안과제 한정 비적용 취지 보존)

### 2026. 7. 22.: v0.22.0

- 과기부 R&D 규정 3건 추가 지원(연구실 안전환경 조성에 관한 법률·시행령·시행규칙 — 연구실 안전 컴플라이언스 / 지원 규정 52 → 55개)

### 2026. 7. 9.: v0.17.0

- 법령의 최근 개정 내용(무엇이 바뀌었는지)을 AI에게 제공 가능하도록 개선(지원 규정 수 52개 불변)
  - 문서 레벨 조회 응답에 개정문(amendment_text — "'출연'을 '지원'으로 한다" 식 공식 개정지시문)과 제개정구분(amendment_kind)을 표시. 종전에는 현행 조문 원문과 개정 마커만 있어 "무엇이 바뀌었는지"는 도구로 알기 어려웠음(법령 트랙 한정)
  - 개정문은 최신 개정분의 원 개정지시문이며 조문별 완전 대조표는 아님을 안내. 새로 제정된 법령은 개정문 대신 "제정"으로 표시
