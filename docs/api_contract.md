...
- 작성일: 2026-05-24 (0.2.0 개정: 2026-06-04, 0.3.0 개정: 2026-06-07, 0.4.0 개정: 2026-06-09, 0.5.0 개정: 2026-06-10)
...
- **search_provision 별표 스니펫**: 공백 정렬 표의 행 중간 절단을 막기 위해 개행(줄) 경계로 자르고, 질의 전 토큰의 매칭 줄을 합집합 멀티윈도우로 발췌(0.2.3 — cap 6·±1줄 맥락·비연속 구간 "…" 구분·≤2000자 불변). 본문 전체 수록/부분 발췌에 따라 마커 2형 부착(전체 수록 시 "발췌" 미표기). 별표 파싱 실패는 `errors`에 `code=annex_parse_failed`로 노출.
