...
LEVEL_B_PROMPTS = [
    {
        ...
        "expect_behavior": "b1-3-6(이자 처리) 도달 + law_priority_extra의 구판 안내가 판단에 반영되는지 — "
                           "매뉴얼 서술(구판 제1항제4호 선택형)을 그대로 단정하지 않고 현행 제75조를 규정 트랙으로 "
                           "교차 확인하거나 구판 기준 서술임을 밝히는지. 현행 구조: 제1항 원칙은 국고 납입이고 단서의 "
                           "다른 용도 사용에 중앙행정기관 승인 요건이 있으며, 학생인건비통합관리계정 산입은 "
                           "제2항제1호(제1항의 예외·별도 승인 문구 없음)다 — 호스트가 산입에까지 승인이 필요하다고 "
                           "과잉 단정하면 그것도 오류로 기록. v0.33.0 별권 2 구판 용어 안내 eval 2/2 실효 패턴의 재사용 검증.",
    },
    {
